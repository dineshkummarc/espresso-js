...
function WebSocket(request) {
	...
	buffer.write(this.input.read(8));
	...
	this.output.print('HTTP/1.1 101 WebSocket Protocol Handshake\r\n');
	this.output.print('Upgrade: WebSocket\r\n');
	this.output.print('Connection: Upgrade\r\n');
	this.output.print('Sec-WebSocket-Origin: ' + request.origin + '\r\n');
	this.output.print('Sec-WebSocket-Location: ws://' + request.host + '' + request.resource + '\r\n');
	this.output.print('\r\n');
